...
import yue_tgbot.modules.sql.notes_sql as sql
from yue_tgbot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from yue_tgbot.__main__ import DATA_IMPORT
from yue_tgbot.modules.helper_funcs.chat_status import user_admin
from yue_tgbot.modules.helper_funcs.alternate import typing_action

# from yue_tgbot.modules.rules import get_rules
import yue_tgbot.modules.sql.rules_sql as rulessql

# from yue_tgbot.modules.sql import warns_sql as warnssql
import yue_tgbot.modules.sql.blacklist_sql as blacklistsql
from yue_tgbot.modules.sql import disable_sql as disabledsql

# from yue_tgbot.modules.sql import cust_filters_sql as filtersql
# import yue_tgbot.modules.sql.welcome_sql as welcsql
import yue_tgbot.modules.sql.locks_sql as locksql
from yue_tgbot.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("yue_tgbot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("yue_tgbot{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `yue_tgbot-Backup` was specially made for notes.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("yue_tgbot{}.backup".format(chat_id))  # Cleaning file
...
__mod_name__ = "Bac/Res"

__help__ = """
*Only for group owner:*

 •/import: Reply to the backup file for the butler / Yui group to import as much as possible, making transfers very easy! \
