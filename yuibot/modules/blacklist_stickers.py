...
import yuibot.modules.sql.blsticker_sql as sql
from yuibot import LOGGER, dispatcher
from yuibot.modules.connection import connected
from yuibot.modules.disable import DisableAbleCommandHandler
from yuibot.modules.helper_funcs.alternate import send_message
...
def __stats__():
    return "╰ {} BlackList Stickers, To {} Groups".format(
...
*ONLY Admin:*
 ...
 • /blstickermode <ban/tban/mute/tmute/off> sets up a default action on what to do if users use blacklisted stickers
