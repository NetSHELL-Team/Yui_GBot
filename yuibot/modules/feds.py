...
import yuibot.modules.sql.feds_sql as sql
from yuibot import (
    EVENT_LOGS,
    LOGGER,
    SUPPORT_CHAT,
...
from yuibot.modules.helper_funcs.chat_status import is_user_admin
from yuibot.modules.helper_funcs.extraction import (
    extract_unt_fedban,
    extract_user,
    extract_user_fban,
)
from yuibot.modules.helper_funcs.string_handling import markdown_parser
...
def __stats__():
    ...
    return "┝ {} Banned Users To {} Federations".format(
