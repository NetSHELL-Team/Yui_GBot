...
import yuibot.modules.sql.notes_sql as sql
from yuibot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from yuibot.__main__ import DATA_IMPORT
from yuibot.modules.helper_funcs.chat_status import user_admin
from yuibot.modules.helper_funcs.alternate import typing_action

# from yuibot.modules.rules import get_rules
import yuibot.modules.sql.rules_sql as rulessql

# from yuibot.modules.sql import warns_sql as warnssql
import yuibot.modules.sql.blacklist_sql as blacklistsql
from yuibot.modules.sql import disable_sql as disabledsql

# from yuibot.modules.sql import cust_filters_sql as filtersql
# import yuibot.modules.sql.welcome_sql as welcsql
import yuibot.modules.sql.locks_sql as locksql
from yuibot.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("yuibot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("yuibot{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `yuibot-Backup` was specially made for notes.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("yuibot{}.backup".format(chat_id))  # Cleaning file
